...
findLambdaWithToms748 <- function(singular_values, degrees_of_freedom, lower_bound = 0., upper_bound = 1e15) {
    .Call(`_compboostSplines_findLambdaWithToms748`, singular_values, degrees_of_freedom, lower_bound, upper_bound)
}
